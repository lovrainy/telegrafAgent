...
//func (c *Config) GetDefault(path string) map[string]string {
//        var err error
//        result := make(map[string]string)
//	dir,_ := filepath.Abs(filepath.Dir(os.Args[0]))
//        fmt.Println(dir)
//	key1,_ := ioutil.ReadFile(dir+"/config/.secret")
//        key1,_ := ioutil.ReadFile("/home/liuyingtu/gopath/src/github.com/influxdata/telegraf/cmd/telegraf/config/.secret")
//        passkey := []byte("DESCRYPT")
//        passiv := []byte("        ")
//        content2 := BytesToString(key1)
//        content3,_ := base64.StdEncoding.DecodeString(content2)
//        passcode,_ := Decrypt(content3, passkey,passiv)
//        passcode1 := BytesToString(passcode)
//	20191118，注释，为windows修改default到global_tags
//        content,_ := ioutil.ReadFile(path)
//        key := []byte(strings.ToLower(passcode1))
//        iv := []byte("00000000")
//        content4 := BytesToString(content)
//        content5,_ := base64.StdEncoding.DecodeString(content4)
//        config_con,_ := Decrypt(content5, key,iv)
//      20191118，注释，为windows修改default到global_tags
//        config_res := BytesToString(content)
//        config_default := strings.Split(config_res,"\n")[:30]
//        conini, err := fconf.NewConfigPar(config_default)
//        conini, err := fconf.NewFileConf(path)
//      20191118，注释，为windows修改default到global_tags
//        if err != nil {
//                fmt.Println(err)
//                return result
//        }
//        escape := conini.String("default.escape_server")
//        daemon := conini.String("default.daemon")
//        running_time := conini.String("default.running_time")
//        interval := conini.String("default.interval")
//        server := conini.String("default.server")
//        agent := conini.String("default.agent")
//        kafkaip := conini.String("default.kafka_ipport")
//        kafkatop := conini.String("default.kafka_topic")
//      20191118，添加，为windows修改default到global_tags
//	escape := c.Tags["escape_server"]
//	daemon := c.Tags["daemon"]
//	interval := c.Tags["interval"]
//	server := c.Tags["server"]
//	agent := c.Tags["agent"]
//	kafkaip := c.Tags["kafka_ipport"]
//	kafkatop := c.Tags["kafka_topic"]
...
//        result["agent"] = agent
//        result["kafka_ipport"] = kafkaip
//        result["kafka_topic"] = kafkatop
//        return result
//}
...
//        content4 := BytesToString(content)
//        content5,_ := base64.StdEncoding.DecodeString(content4)
//        return Decrypt(content5, key,iv)
